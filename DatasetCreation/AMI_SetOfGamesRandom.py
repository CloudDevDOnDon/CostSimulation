...
AMI_list = {
    "eSports" : ["Dota 2", "Counter Strike: Global Offensive", "Valorant", "League of Legends", "Fortnite"],
    "RPG" : ["Final Fantasy XIV", "MapleStory", "Runescape 3", "Destiny 2", "Old School Runescape", "World of Warcraft", ],
    "RPG_2" : ["Phantasy Star Online 2","Tera", "MineCraft"],
    "Co-Op": ["Left 4 Dead 2", "WarFrame", "OverCooked! 2", "Fall Guys! Ultimate Knockout", "Monster Hunter World"],
    "FPS" : ["Rainbow Six: Siege", "Player Unknowns Battleground", "Halo: The Master Chief Collection", "Call of Duty Black Ops: Modern Warfare"],
    "Racing" : ["Forza Horizon 4", "The Crew 2"],
    "Ubisoft_ex" : ["Ghost Recon Breakpoint", "For Honor", "Watch Dogs Legion", "Assasin's Creed: Valhalla", "The Division 2"]
}
